// Implement Deqeue Using Doubly Linked List
		...
		while(c!=6)
		{
			...
			switch(c)
			{
				...
				case 3:
					...
					break;
				case 5:
					System.out.print("List from Front ---> Rear: ");
					dqueue.displayQueue();
					break;
				case 6:
					break;
...
6.Exit
5
List from Front ---> Rear: 20 10 30 40
Enter your choice(1-4):
1.Insert Front
2.Insert Rear
3.Delete Front
